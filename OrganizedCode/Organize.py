...
import threading
import time
from PressureSensor import read_data
...
class PressureSensorApp(tk.Tk):
    ...
    def get_data_from_com_port(self) -> np.ndarray:
        return read_data.get_data_from_com_port(self)
    ...
    def get_data_from_recorded_data(self) -> np.ndarray:
        return read_data.get_data_from_recorded_data(self)
    
    def get_data_simulated(self) -> np.ndarray:
        return read_data.get_data_simulated(self, MIN_VAL, MAX_VAL)
